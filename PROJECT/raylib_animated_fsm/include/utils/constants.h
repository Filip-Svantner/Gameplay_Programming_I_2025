...
#define DEFAULT_MOVEMENT_SPEED 130.0f

#define NPC_MIN_AGGRESSION 0.3f
#define NPC_MAX_AGGRESSION 0.8f

#define NPC_AGGRESSION_BUILD 0.2f
#define NPC_AGGRESSION_DECAY 0.3f
